...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        logger.debug('Command class loaded successfully.')
        # Connect to MongoDB
        ...
        # Use pymongo to insert users directly into MongoDB
        user_documents = [
        ...
        # Retrieve inserted users from MongoDB
        users = list(db.users.find())

        # Use pymongo to insert teams directly into MongoDB
        team_documents = [
            {"_id": ObjectId(), "name": "Blue Team", "members": []},
            {"_id": ObjectId(), "name": "Gold Team", "members": []},
        ]
        db.teams.insert_many(team_documents)
